...
import { Star, GitFork, Flame, Sparkles, Clock, Globe, Code2, Database, Bot, Mail, Users, TrendingUp, Search } from 'lucide-react';
        ...
        <div className="bg-surface border border-line rounded-2xl p-6 sm:p-8">
          ...
          <div className="space-y-3">
            ...
            <a 
              ...
              className="flex items-center gap-3 text-text-primary hover:text-accent transition-colors group"
            >
              <GithubIcon className="w-4 h-4 text-text-tertiary group-hover:text-accent transition-colors" />
